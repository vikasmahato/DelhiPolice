  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#">Referral/Govt. Claim<span class="sr-only">(current)</span></a></li>
     ...
     <h3>FILL THE CLAIM DETAILS AND THE DOCUMENTS SUBMITTED</h3>
         <form name="myForm" class="form-horizontal" id="refCheck" onsubmit="return validateForm()" action="add_new_referral.php" method="post">
...
<div class="row">
  <div class="col-lg-6">
    <div class="input-group">
      <span id="pgspan" class="input-group-addon">
        <input type="checkbox" name="reason" required="true"> <b>Reason for Late Submission</b>
      </span>
    </div>
  </div>
  ...
  <div class="col-lg-6">
    <div class="input-group">
      <span id="pgspan" class="input-group-addon">
        <input type="checkbox" name="deathCertificate" required="true"> <b>Death Certificate</b>
      </span>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-lg-6">
    <div class="input-group">
      <span id="pgspan" class="input-group-addon">
        <input type="checkbox" required="true"> <b>Copy of Refer Slip</b>
      </span>
    </div>
  </div>
    
  <div class="col-lg-6">
    <div class="input-group" id="pgno">
      <span id="pgspan" class="input-group-addon">
        <input type="checkbox" required="true"> <b>Permission</b>
      </span>
    </div>
  </div>
</div>-->
<input type="hidden" name="ctype" value="opref">
