...
VALUES ('$appName', '$pis', '$rank', '$relation', '$startDate', '$endDate', '$hospitalName', '$policestationNo', '$diaryNo', $appCGHSno, '$appCGHSexp',$refCGHSno, '$refCGHSexp', '$appCGHScategory', '$diaryDate', 'CREDIT', 'HAG')";
