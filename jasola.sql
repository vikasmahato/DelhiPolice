...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2017 at 05:32 PM
...
INSERT INTO `comments` (`app_id`, `user_id`, `comment`) VALUES
(33, 'acp', 'HELLO'),
(37, 'hag', 'real madrid'),
(35, 'hag', 'ronaldo'),
(36, 'iadmin', 'messi'),
...
CREATE TABLE `form` (
  ...
  `status` enum('NULL','D_HAND','HAG','I_ADMIN','ACP','PHQ','DCP','FAILED','APPROVED','REEVAL_IADMIN','REEVAL_HAG','REEVAL_ACP') DEFAULT NULL,
  `period` varchar(15) NOT NULL,
  `claim_type` enum('IP_REFERRAL','IP_EMERGENCY','OP_REFERRAL','OP_EMERGENCY','CREDIT','PERMISSION') NOT NULL,
  `hospType` char(7) NOT NULL,
  `phq_memo` varchar(10) NOT NULL,
  `phq_memo_date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `form` (`app_id`, `applicant_name`, `pis`, `rank`, `relation`, `pincode`, `startdate`, `enddate`, `hospital_name`, `hospital_address`, `police_station_no`, `si_no`, `diary_no`, `ref_hospital_name`, `a_cghs_no`, `a_cghs_exp`, `r_cghs_no`, `r_cghs_exp`, `a_cghs_category`, `disease`, `application_date`, `diary_date`, `amt_asked`, `amt_granted`, `amt_available`, `status`, `period`, `claim_type`, `hospType`, `phq_memo`, `phq_memo_date`) VALUES
(32, 'Ankit', '1722/SE', 'Police Constable', 'wife', NULL, '2016-12-02', '2016-12-10', 'SJ', NULL, '1722/SE', NULL, '8025', NULL, 27335, '2017-06-08', 27335, '2017-05-12', 'general', NULL, '2016-12-22', '0000-00-00', NULL, NULL, NULL, 'DCP', '', 'PERMISSION', '', '', '0000-00-00'),
(33, 'AShutoish', '2045/SE', 'Senior Police Constable', 'NULL', NULL, '2016-12-01', '2016-12-10', 'AIIMS', NULL, '2077/SE', NULL, '1246', NULL, 9853, '2017-05-13', NULL, '0000-00-00', 'General', NULL, '2016-12-22', '0000-00-00', NULL, NULL, NULL, 'APPROVED', '', 'CREDIT', '', '', '0000-00-00'),
(34, 'Lalu Yadav', '3256/BIq', 'Police Constable', 'NULL', 110045, '2016-12-01', '2016-12-22', 'MAX', 'Saket', '265/BI', NULL, '21251', 'SJ', 13132, '2016-12-17', NULL, '0000-00-00', 'private', 'headache', '2016-12-22', '0000-00-00', 2586.00, 409.00, NULL, 'I_ADMIN', '21', 'OP_REFERRAL', '', '', '0000-00-00'),
(35, 'Chota Bheem', '1622/MH', 'Assistant Commissioner of Police', 'NULL', 110023, '2016-12-06', '2016-12-07', 'aiims', 'DELHI', '1622/MH', NULL, '12343', 'NULL', 234234, '2016-12-22', NULL, '0000-00-00', 'Private', 'diarrhoea', '2016-12-14', '0000-00-00', 1234.00, 608.00, NULL, 'I_ADMIN', '1', 'OP_EMERGENCY', '', '', '0000-00-00'),
(36, 'Arpit', '1232', 'Inspector of Police', 'NULL', NULL, '2016-12-08', '2016-12-11', 'MAX', NULL, '1567/SE', NULL, '1232221', NULL, 213213123, '2016-12-30', NULL, '0000-00-00', 'Private', NULL, '2016-12-15', '0000-00-00', NULL, NULL, NULL, 'I_ADMIN', '', 'PERMISSION', '', '', '0000-00-00'),
(37, 'ASHISH', '1753/SE', 'YAdditional Deputy Commissioner of Police', 'NULL', NULL, '0000-00-00', '0000-00-00', 'AIIMS', NULL, '1753/SE', NULL, '2334425', NULL, 324422313, '0000-00-00', NULL, '0000-00-00', 'General', NULL, '0000-00-00', '0000-00-00', NULL, NULL, NULL, 'HAG', '', 'CREDIT', '', '19945', '0000-00-00'),
(38, 'NITIN', '1724/SE', 'YAdditional Deputy Commissioner of Police', 'NULL', NULL, '0000-00-00', '0000-00-00', 'MAXX', NULL, '1743/SE', NULL, '125432', NULL, 485940, '0000-00-00', NULL, '0000-00-00', 'General', NULL, '0000-00-00', '0000-00-00', NULL, 0.00, NULL, 'PHQ', '', 'CREDIT', '', '', '0000-00-00'),
(39, 'Viaks', '215/se', 'Police Constable', 'NULL', 110049, '2016-12-15', '2016-12-24', 'AIIMS', 'Green Park', '12315/se', NULL, '1562', 'Safdurjung', 1649523, '2016-12-16', NULL, '0000-00-00', 'General', 'HeadAche', NULL, '2016-12-15', 9864.00, 970.00, NULL, 'REEVAL_ACP', '9', 'OP_REFERRAL', '', '', '0000-00-00'),
(40, 'Dharmendra Singh', '28981507', 'Police Head Constable', 'Wife', 110014, '2016-12-15', '2016-12-20', 'MAX', 'Saket', '652/SE', NULL, '11362', 'NULL', 1072057, '2020-06-30', 1072071, '2020-06-30', 'General', 'Anemia', NULL, '2016-12-21', 19584.00, 2300.00, NULL, 'I_ADMIN', '5', 'OP_EMERGENCY', '', '', '0000-00-00'),
(41, 'Sapna Mishra', '123456/SE', 'Police Constable', 'NULL', 110049, '2017-01-12', '2017-01-19', 'MAx', 'Saket', '123456/SE', NULL, '1116', 'Safdurjung', 123456, '2017-01-28', NULL, '0000-00-00', 'Private', 'Dream Girl', NULL, '2017-01-12', 123.00, 0.00, NULL, 'I_ADMIN', '7', 'OP_REFERRAL', 'nonnabh', '', '0000-00-00'),
(42, 'Vikas Prasad Mahato', '1994/SE', 'Senior Police Constable', 'NULL', 110049, '2017-01-12', '2017-01-06', 'AIIMS', 'Green Park', '1994/SE', NULL, '123456', 'Safdurjung', 123456789, '2017-01-20', NULL, '0000-00-00', 'Private', 'None', NULL, '2017-01-18', 15000.00, 150.00, NULL, 'REEVAL_ACP', '6', 'OP_REFERRAL', 'nonnabh', '', '0000-00-00'),
(43, 'Vikas', '4512', 'Police Constable', 'NULL', NULL, '0000-00-00', '0000-00-00', 'AIIMS', NULL, '12345', NULL, '4522', NULL, 546123, '0000-00-00', NULL, '0000-00-00', 'General', NULL, NULL, '0000-00-00', NULL, 120.00, NULL, 'REEVAL_HAG', '', 'CREDIT', '', '', '0000-00-00'),
(44, 'Batman', '23133/SE', 'Senior Police Constable', 'NULL', NULL, '2016-11-11', '2016-11-12', 'Safdurjung', NULL, '54612/SE', NULL, '45621', NULL, 12345678, '2017-11-11', NULL, '0000-00-00', 'Private', NULL, NULL, '2017-11-11', NULL, NULL, NULL, 'REEVAL_ACP', '', 'CREDIT', '', '', '0000-00-00');
...
INSERT INTO `medical` (`app_id`, `s_no`, `treatment`, `total`, `index`) VALUES
(34, 5, 'Aspiration Plural Effusion - D', 120, 0),
(34, 1, 'Consultation OPD', 150, 0),
(34, 21, 'Intercostal Drainage', 125, 0),
(34, 13, 'Venesection', 124, 0),
(34, 26, 'Excision of Veneral Warts', 160, 0),
(35, 21, 'Intercostal Drainage', 125, 0),
(35, 24, 'Excision of Warts', 310, 0),
(35, 15, 'Sternal puncture', 173, 0),
(38, 0, '', 0, 0),
(38, 0, '', 0, 0),
(39, 71, 'Fluorescein angiography for fu', 920, 0),
(39, 3, 'Dressings of wounds', 50, 0),
(40, 1419, 'Cross match', 50, 0),
(40, 2, 'Consultation- for Inpatients', 300, 0),
(40, 1513, 'Liver Function Test.', 225, 0),
(40, 1281, 'Upper G.I. Endoscopy + Lower G', 1725, 0),
(40, 0, '', 0, 0),
(41, 1594, 'Neonatal head (Tranfontanellar', 425, 0),
(41, 1, 'Consultation OPD', 150, 0),
(41, 3, '', 0, 0),
(41, 1, 'Consultation OPD', 150, 0),
(42, 1, 'Consultation OPD', 150, 0),
(42, 1, 'Consultation OPD', 150, 0),
(43, 5, 'Aspiration Plural Effusion - D', 120, 0);
...
CREATE TABLE `table` (
  ...
  `cghs_treatment` varchar(62) DEFAULT NULL,
  `non_nabh_non_nabl` int(4) DEFAULT NULL,
  `nabh_nabl` int(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `table` (`s_no`, `cghs_treatment`, `non_nabh_non_nabl`, `nabh_nabl`) VALUES
(1, 'Consultation OPD', 150, 150),
(2, 'Consultation- for Inpatients', 300, 300),
(3, 'Dressings of wounds', 50, 58),
(4, 'Suturing of wounds with local anesthesia', 108, 124),
...
(32, 'Pterygium Surgery', 5500, 6325),
(33, 'Conjunctival Peritomy', 58, 67),
(34, 'Conjunctival wound repair or exploration following blunt', 3300, 3795),
(35, 'Removal of corneal foreign body', 115, 132),
(36, 'Cauterization of ulcer/subconjunctival injection in one eye', 69, 79),
(37, 'Cauterization of ulcer/subconjunctival injection in both eyes', 138, 159),
(38, 'Corneal grafting?Penetrating keratoplasty', 5750, 6613),
...
--
ALTER TABLE `form`
  MODIFY `app_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
