    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="ip_emgChecklist.php">Emergency Credit Claim</a></li>
          <li class="active"><a href="creditCheck.php">P. Credit<span class="sr-only">(current)</span></a></li>
     ...
     <h3>FILL THE CLAIM DETAILS AND THE DOCUMENTS SUBMITTED</h3>
         <form name="myForm" class="form-horizontal" id="creditCheck">
...
<input type="hidden" name="ctype" value="credit">
