  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <!-- <li><a href="ip_refChecklist.php">IP-Referral</a></li>-->
        <li class="active"><a href="#">Emergency Credit Claim<span class="sr-only">(current)</span></a></li>
     ...
     <h3>FILL THE CLAIM DETAILS AND THE DOCUMENTS SUBMITTED</h3>
         <form name="myForm" class="form-horizontal" id="refCheck">
...
<!--         <div class="input-group">
       ...
       <input type="hidden" name="ctype" value="emgctd">
